          ...
          <a href="../page/chitietsanpham.php?id=<?= $row['id'] ?>" style="text-decoration: none;">
            <div class="card" >
              <div class="card-body">
                ...
                <h2 style="font-size: 16px; color:black;" class="card-titel text-center"><?= $row['name_product'] ?></h2>
                ...
                <a href="../page/chitietsanpham.php?id=<?= $data['id'] ?>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h2 style="font-size: 16px; color:black;" class="card-titel text-center"><?= $data['name_product'] ?></h2>
