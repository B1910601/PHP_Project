...
<body>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="view.php">Liệt kê</a>
    ...
    <h1 class="text-center" style="font-weight:bold ; margin-top: 50px;">Thêm danh mục</h1>
    <div class="container">
        <div class="row">
                        ...
                        <form autocomplete="off" method="post" class="form-horizontal" action="xuly.php">
                            ...
                            <div class="row">
                                <div class="col-sm-5 offset-sm-4">
                                    <button type="submit" class="btn btn-primary" name="insert">Thêm danh mục</button>
                                </div>
                            </div>
