...
<body>
    ...
    <h1 class="text-center" style="font-weight:bold ; margin-top: 50px;">Thêm sản phẩm</h1>
    <div class="container">
        <div class="row">
            <div class="col-sm-8 offset-sm-2">
                ...
                <div class="">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" autocomplete="off" method="post" class="form-horizontal" action="./code.php">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="name">Giá</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="password">Mô tả</label>
                                <div class="col-sm-5">
                                ...
                                ?>
                                <label class="col-sm-4 col-form-label" for="password">Thuộc danh mục</label>
                                <select name="iddm" id="">
                                    <?php
                          ...
                          <option  value="' . $row['id_category'] . '">' . $row['name_category'] . '</option>	
                                ...
                                <div class="form-group row" style="padding-left: 2%;">
                                    ...
                                    <!-- <div class="form-group row">
								<label class="col-sm-4 col-form-label">Img</label>
								<div class="col-sm-5">
									<input type="file"  name="image"  />
								</div>
							</div> -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5 offset-sm-4">
                                            <button type="submit" class="btn btn-primary" name="insertsp">Thêm Sản
                                                Phẩm</button>
                                        </div>
                                    </div>
