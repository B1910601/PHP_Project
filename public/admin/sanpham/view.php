...
<body>
    ...
    <div class="card-body">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM product,category_product WHERE product.id_category=category_product.id_category ORDER BY product.id DESC ";
                ...
                <tr>
                    ...
                    <td style="display: block; /* Fallback trong trường hợp trình duyệt không hỗ trợ display dạng box */
    display: -webkit-box;
    line-height: 16px; 
    max-height: 74px; 
    -webkit-line-clamp: 3; 
    ...
    overflow:hidden;
    max-width: 400px; "><?= $data['description_product']; ?></td>
                    <td><?= $data['name_category']; ?></td>
                    <td><img src="../uploads/<?= $data['image'] ?>" width="200" height="200"></td>
                    <td><?= $data['price_product']; ?></td>
                    <td><a href="edit.php?id=<?= $data['id']; ?>" class="btn btn-primary">Edit</a></td>
                    <td>
                        <form action="code.php" method="post">
                            <button type="submit" name="delete" value="<?= $data['id']; ?>"
                ...
                <?php
                    ...
                    ?>
                <tr>
                    <td colspan="3">Không có san pham</td>
                </tr>
                <?php
                }
                ?>
